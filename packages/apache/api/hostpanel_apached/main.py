"""
hostpanel-apached — the Apache package API.
"""
...
from hostpanel_apached import routes
...
def main() -> None:
    ...
    port = int(os.environ.get("HP_PACKAGE_PORT", "9106"))
    host = os.environ.get("HP_PACKAGE_HOST", "127.0.0.1")
    _log.info("hostpanel-apached starting on %s:%d", host, port)
